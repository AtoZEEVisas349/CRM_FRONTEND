...
<section className={`sidebar_container ${isActive ? "active" : ""}`}>
  ...
  <ul className="submenu_nav">
    <li><Link to="/freshlead" className="submenu_item"><FontAwesomeIcon icon={faUsers} /> Fresh Leads</Link></li>
    <li><Link to="/follow-up" className="submenu_item"><FontAwesomeIcon icon={faList} /> Follow ups</Link></li>
    <li><Link to="/customer" className="submenu_item"><FontAwesomeIcon icon={faClock} /> Convert</Link></li>
    <li><Link to="/close-leads" className="submenu_item"><FontAwesomeIcon icon={faCircleXmark} /> Close</Link></li>
  </ul>
)}
